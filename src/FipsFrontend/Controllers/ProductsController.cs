...
public class ProductsController : Controller
{
    ...
    public ProductsController(ILogger<ProductsController> logger, CmsApiService cmsApiService, IOptimizedCmsApiService optimizedCmsApiService, IOptions<EnabledFeatures> enabledFeatures, IConfiguration configuration, ISearchTermLoggingService searchTermLoggingService, IServiceAssessmentsService assessmentsService)
    {
        _logger = logger;
