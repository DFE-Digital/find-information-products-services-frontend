...
var productsResponse = await _cmsApiService.GetAsync<ApiCollectionResponse<Product>>(
   $"products?pagination[page]={cmsPage}&pagination[pageSize]={pageSize}&populate=*"
);
...
var allProducts = productsResponse?.Data ?? new List<Product>();
            ...
            if (!string.IsNullOrEmpty(keywords))
            {
                ...
                searchQuery += $"&pagination[page]={cmsPage}&pagination[pageSize]={pageSize}&populate[category_values][populate][category_type]=true&populate[product_contacts]=true";
            ...
            else
            {
                ...
                var filterQueryWithPagination = $"products?{filterQuery}&pagination[page]={cmsPage}&pagination[pageSize]={pageSize}&populate[category_values][populate][category_type]=true&populate[product_contacts]=true";
        ...
        List<CategoryValue> groupValues, List<CategoryValue> userGroupValues)
    {
        ...
        var allProductsResponse = await _cmsApiService.GetAsync<ApiCollectionResponse<Product>>("products?pagination[pageSize]=10000&populate[category_values][populate][category_type]=true");
